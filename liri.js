...
// ==========================================================Liri=======================================================
// get action and search from prompt answers below
// constructor function used to create Liri's return 
function Liri(action, search) {
    ...
    this.selector = function () {
        ...
        if (this.action === "concert-this") {
            ...
            // If no artist or band is provided then your program will default to "The Sign" by Ace of Base.
            else {
                console.log("I found no concert for this one.")
            }
            ...
            if (this.search !== undefined) {
                ...
                console.log("But I need a song's name. For example:")
                this.search = "The Sign Ace of Base"
                this.spotify()
                logAction = this.action + `,"` + this.search + `"`
                appendLog(logAction)
            }
            ...
            if (this.search !== undefined) {
                ...
                console.log("But I need a movie's name. For example:")
                this.search = "Mr. Nobody"
                this.movie()
                logAction = this.action + `,"` + this.search + `"`
                appendLog(logAction)
            }
